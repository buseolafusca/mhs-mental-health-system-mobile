...
import { baseUrl, patientanswersUrl } from '../variables/URLs'
...
describe('Test ReviewPage willMount', () => {
  ...
  test('calls `componentWillMount` before rendering', () => {
    ...
    SurveyResult.prototype.componentWillMount = onWillMount;
    mount(<SurveyResult />);
